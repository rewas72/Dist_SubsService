...
class Capacity {
    ...
    @Override
    public String toString() {
        return "server2_status: " + serverStatus + ", timestamp: " + timestamp;
    }
}
...
public class Server3 {
    ...
    public static void handleClient(Socket clientSocket) {
        try (BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
            ...
            System.out.println("Server2 üzerinde istemciden gelen mesaj: " + message);
            ...
            if ("STRT".equals(message)) {
                ...
                System.out.println("Server2 üzerinde istemciden gelen mesaj sonucu: " + responseMsg);
                
                Capacity capacity = new Capacity(1000);
                responseText = capacity.toString();
                System.out.println("Server2 üzerinde kapasite yanıtı: " + responseText);
            } else {
    ...
    public static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            new Thread(() -> pingOtherServer("localhost", 5000)).start();
